...
VideoCapture cap("./sensor.mp4");//open video file
...
int c = cap.get(CAP_PROP_FRAME_COUNT);
...
p = cap.get(CAP_PROP_POS_FRAMES);
//printf("Frame: %ld \n", p);
ms = cap.get(CAP_PROP_POS_MSEC);
str = to_string(ms) + " ms";
