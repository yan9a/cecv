...
String face_cascade_name = "c:/opencv/haarcascade_frontalface_alt.xml";
String eyes_cascade_name = "c:/opencv/haarcascade_eye_tree_eyeglasses.xml";
...
int main(int argc, char** argv)
{
	...
	//VideoCapture cap("/home/yan/faces.mp4");//open video file
	//VideoCapture cap("c:/opencv/face.mp4"); //open video file
